...
angular.module('ngAnimate', ['ng'])
  ...
  .config(['$provide', '$animateProvider', function($provide, $animateProvider) {
    ...
    $animateProvider.register('', ['$window', '$sniffer', '$timeout', '$$animateReflow',
      ...
      // Also, the only modern browser that uses libs prefixes for transitions/keyframes is webkit
      // therefore there is no reason to test anymore for other libs prefixes: http://caniuse.com/#search=transition
